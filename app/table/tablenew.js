import styles from './tablenew.scss';

class TableNew extends HTMLElement {
    constructor() {
        super();
    ...
    connectedCallback() {
        ...
        const nestedTables = this.querySelectorAll('t-table-new');
    ...
    handleRowClick(event) {
        ...
        if (nextRow) {
            ...
            if (hasNestedTable) {
                ...
                const nestedTable = nextRow.querySelector('t-table-new');
                ...
                if (nestedTable && event.target.tagName.toLowerCase() !== 't-table-new') {
...
customElements.define('t-table-new', TableNew);
