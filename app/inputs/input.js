...
class InputText extends HTMLElement {
  ...
  constructor() {
    ...
    let template = "";
    let iconrotaion = this.hasAttribute("lang")//lang=languge
      ? this.getAttribute("lang") == "ar"   //ar=arebic
        ? 'style="direction: rtl;"'   // right to left
        : ""
      : "";
    let inputWidth = "";
  ...
  checkValidity() {// inbuild methods given by hmtl5
